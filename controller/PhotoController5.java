 ...
 */
public class PhotoController5 implements PhotoController {
    ...
    /**
     * photoArray[][]- A matrix of photos, each topic has a row. This structure was chosen to make the code more efficient.
     */
    ...
    public PhotoController5(PhotoFinder finder, PhotoViewer viewer) {
        this.finder = finder;
        this.viewer = viewer;
    }
